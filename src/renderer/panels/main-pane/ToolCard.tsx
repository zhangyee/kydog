...
import { groupToolLabel, RUNNING_OUTPUT_PLACEHOLDER, toolExpandable, toolStatusLabel } from './toolSummary';
...
export function ToolCard({ tool }: Props) {
  ...
  const expandable = toolExpandable(tool);
  const waiting = !hasOutput && tool.status === 'running';
